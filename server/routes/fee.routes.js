module.exports = app => {
  ...
  router.post("/", verifyToken, fees.create);
  ...
  router.put("/:id", verifyToken, fees.update);

  // Delete a Fee Structure with id
  router.delete("/:id", verifyToken, fees.delete);

  // Delete all Fee Structures
  router.delete("/", verifyToken, fees.deleteAll);
